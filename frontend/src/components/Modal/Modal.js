  ...
  return createPortal(
    ...
    >
      <div className={styleSettings.container}>
        <div className={styleSettings.content} ref={modalRef}>
...
Modal.Header = function ModalHeader(props) {
  ...
  return (
    <header className={styleSettings.header}>
      {props.children}
      <button
...
Modal.Body = function ModalBody(props) {
  ...
  return <main className={styleSettings.main}>{props.children}</main>;
};
Modal.Footer = function ModalFooter(props) {
  const { styleSettings } = useContext(modalContext);

  return <footer className={styleSettings.footer}>{props.children}</footer>;
};
